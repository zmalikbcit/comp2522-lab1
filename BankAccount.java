...
public class BankAccount
{
    ...
    private static final int MAX_PIN_DIGIT = 4;
     ...
     * @param pin the MAX_PIN_DIGIT PIN for the account
     * @param accountNumber the account number (must be between MIN_ACCOUNT_NUMBER_LENGTH or MAX_ACCOUNT_NUMBER_LENGTH )
                                            ...
                                            final Date accountOpened)
    {
        ...
        {
            throw new IllegalArgumentException("PIN must be a " + MAX_PIN_DIGIT + "-digit number");
        }
